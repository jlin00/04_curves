...
void parse_file ( char * filename,
  ...
  while ( fgets(line, sizeof(line), f) != NULL ) {
    ...
    if (strncmp(line, "circle", strlen(line)) == 0){
      ...
      add_curve(edges, xvals[0], yvals[0], xvals[1], yvals[1], xvals[2], yvals[2], xvals[3], yvals[3], 0.02, HERMITE);
    }
      ...
      sscanf(line, "%lf %lf %lf %lf %lf %lf %lf %lf",
              xvals, yvals, xvals+1, yvals+1, xvals+2, yvals+2, xvals+3, yvals+3);
      add_curve(edges, xvals[0], yvals[0], xvals[1], yvals[1], xvals[2], yvals[2], xvals[3], yvals[3], 0.02, BEZIER);
    }
